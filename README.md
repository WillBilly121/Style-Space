...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ROI y Salarios - Style Space</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            margin: 40px;
...
<body>
    <h1>Style Space - Análisis Financiero</h1>
    ...
    <section>
        <h2>Desglose de Salarios</h2>
        <table>
            <tr><th>Puesto</th><th>Salario Anual ($)</th><th>Salario Mensual ($)</th></tr>
